...
const PolicyPage = () => {
  return (
    <section className="notice pb-20 pt-40">
      ...
      <div className="ml-6">
        <p>
          当院では以下のようにプライバシーポリシーを掲げ、
          お客様の個人情報の保護につとめています。
        </p>
        <p>
          当院のサービスもしくは商品を購入した場合、
          または当院の物品の無料進呈等キャンペーンに応募した場合には、
      ...
      <div className="ml-6">
        <p>当院は、以下の目的で個人情報を収集または利用いたします。 </p>
        <ol className="ml-6">
          <li>教材の配送、及び、Eメールや郵送等によるニュースレターの送信</li>
          <li>
            当院、または、セミナーの主催者もしくは共催者、当院と商品
            もしくはサービスを共同で販売する第三者または当院と
            共同でキャンペーンを行う第三者その他のビジネス・パートナー
            （以下あわせて「ビジネス・パートナー」といいます）の
            商品の発送に関する情報、商品・サービスに関する情報を提供するため
          </li>
          <li>
            当院および当院のビジネス・パートナーのサービスもしくは商品の
            開発・改善を目的とした調査・検討を行うため
          </li>
          <li>
            当院および当院のビジネス・パートナーのサービス
            もしくは商品に関する統計的資料を作成するため
          </li>
          <li>当院および当院のビジネス・パートナーの求人情報を提供するため </li>
          <li>
            その他当院の経営方針もしくはマーケティング戦略の策定・改善を目的とした
            調査・検討を行うため
          </li>
          <li>お客様からの問い合わせに対して、回答や連絡を行うため</li>
          <li>お客様にとって当院が有益であると判断した情報を提供するため</li>
        </ol>
      </div>
      <h3>情報の第三者への開示について</h3>
      <div className="ml-6">
        <p>
          当院は、下記に該当する場合を除き、お客様の同意なく
          個人情報を第三者に開示することはありません。
        </p>
        <p>当院は、以下のとおり、個人情報を共同利用することがあります。</p>
        <ol className="ml-6">
          <li>
        ...
        <div className="ml-6">
          <ol>
            ...
            <li>
              その他当院の経営方針もしくはマーケティング戦略・営業戦略の
              策定・改善を目的とした調査・検討を行うため
            </li>
            <li>
              お客様にとって当院またはビジネス･パートナーが有益であると
              判断した情報を提供するため
            </li>
        ...
        <h4>
          当院は、以下の場合には個人情報を第三者に開示することがあります。
        </h4>
        <div className="ml-6">
          <ol>
            ...
            <li>
              ...
              また、その他公共の利益のために特に必要があると当院が判断した場合
            </li>
            <li>
      ...
      <h3>保有個人データの開示等</h3>
      <div className="ml-6">
        <p>お客様は、当院所定の手続により、以下の請求を行うことができます。</p>
        <ol>
          <li>
            当院の保有する自己の保有個人データが誤った情報でないことを確認すること
            （保有個人データの開示）
          </li>
          <li>
            当院の保有する自己の保有個人データの利用目的の通知（保有個人データの利用目的の通知）
          </li>
          <li>
            当院の保有する自己の保有個人データが誤った情報である場合に、
        ...
        <div className="ml-6 mb-10">
          ...
          <div className="ml-14">まきせ鍼灸整骨院 - 個人情報保護事務局</div>
        </div>
      ...
      <div className="ml-6">
        ...
        <ul>
          <li>
            ...
            住所・当院の登録住所が一致しないときなどご本人が確認できない場合
          </li>
      ...
      <div className="ml-6">
        <p>
          当院では、個人情報の不当なアクセスによる紛失、破壊、改ざん、漏洩などのリスクに対して、
          合理的かつ厳正な安全対策を講じておりますが、
          以下の事由など当院の責に帰すべからざる事由を原因とする
          個人情報の紛失、破壊、改ざん、漏洩などに関しては、
          当院では責任を負いかねますので、ご注意ください。
        </p>
        <ol>
          <li>
            誰でもアクセスできる形態でインターネット上に個人情報を開示した場合
          </li>
          <li>当院以外のウェブサイトにおいて個人情報を開示した場合</li>
      ...
      <div className="ml-6">
        ...
        <p>
          プライバシーポリシー変更後は、当院が別途定める場合を除いて、
          当院のウェブサイトに掲載した時から効力を生じるものとします。
        </p>
      </div>

      <h3 className="warning">＊お客様へのご協力のお願い＊</h3>
      <div className="ml-6">
        <p>当院より、個人情報を含むメールが配信される場合は以下の通りです。</p>
        <p>
          ...
          <dd className="text-sm mt-[-1em]">
            ...
            >
              <span className="link text-sm">
                info+makise-seikotsu@alizza-ideal.com
              </span>
            </Link>
          </dd>
          <dt>電話番号</dt>
          <dd className="text-sm mt-[-1em]">
            <Link href="tel:0292240076">029-224-0076</Link>
          </dd>
        </dl>
      </div>
    </section>
