...
const brandData: Brand[] = [
  {
    ...
    imageLight: "",
    content: (
      <div className="opacity-90 transition-all duration-300 hover:opacity-100 border-4 p-0 border-white rounded-xl text-white font-bold m-0 text-base text-center w-full md:w-[180px] whitespace-nowrap">
  ...
  },
  {
    ...
    content: (
      <div className="opacity-90 transition-all duration-300 hover:opacity-100 border-4 p-0 border-white rounded-xl text-white font-bold m-0 text-base text-center w-full md:w-[180px] whitespace-nowrap">
        ...
        <div className="px-1 m-0 text-xs">12月7日まで</div>
      </div>
    )
  }
]
