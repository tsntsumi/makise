        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5 flex-wrap md:flex-nowrap">
            ...
            >
              ...
              <div>
                <p>
                  わたしは、患者様の痛みの部分だけをみて施術して、そのときだけ痛みを取り除けばいいとは考えていません。
                </p>
                ...
                <h3>大事なのは治療技術だけじゃない</h3>
                <p>
                  そんな治療に大事なのは、患者様と話し合うことです。
                  どんなことに悩んでいるのか、どんなことをできるようになりたいのか、
                  しっかりとお話をお聞きします。
                </p>
                <p>
                ...
                <h3>治すのは、わたしではなく、あなた</h3>
                <p>
                  言わば、わたしが患者様を治すのではなく、
                  患者様自身が主体となって治療を進めていくということです。
                </p>
                <p>
                  そういった意味で、患者様のニーズに合わせて施術をカスタマイズします。
                  症状にピッタリあったオーダーメイドの治療を提供いたします。
                </p>
                <p>
                  それによって、痛みを取るだけでなく、患者様の生活の質が向上し、
        ...
        <div className="mx-auto max-w-c-1235 px-4 md:px-8 xl:px-0">
          <div className="flex items-center gap-8 lg:gap-32.5 flex-wrap md:flex-nowrap">
            <motion.div
              ...
              transition={{ duration: 0.5, delay: 0.1 }}
              viewport={{ once: true }}
              className="animate_left relative mx-auto items-center justify-center block w-2/3 md:w-1/3"
            ></motion.div>
            <motion.div
              variants={{
                hidden: {
