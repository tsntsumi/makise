...
const brandData: Brand[] = [
  ...
  },
  {
    ...
    imageLight: "",
    content: (
      <div className="opacity-90 transition-all duration-300 hover:opacity-100 border-2 p-0 py-1 border-white rounded-xl text-white font-bold m-0 text-sm md:text-base text-center w-full md:w-[180px] whitespace-nowrap h-full flex flex-col justify-around md:py-2">
        <div className="px-1 p-0 m-0 text-xs md:text-sm">初回特別価格</div>
        <div className="px-1 p-0 m-0 text-xl">
